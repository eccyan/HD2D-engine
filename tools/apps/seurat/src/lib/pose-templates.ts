 ...
 *  Proportions from reference: nose y=0.10, neck y=0.18, hips y=0.39, ankles y=0.74.
 *  Profile is compact horizontally (shoulders ~0.08 apart, hips ~0.06). */
const IDLE_RIGHT: Pose[] = [
  ...
  [[0.52, 0.10], [0.49, 0.18], [0.44, 0.20], [0.40, 0.30], [0.40, 0.40],
   [0.54, 0.20], [0.56, 0.30], [0.56, 0.40],
   [0.45, 0.39], [0.45, 0.56], [0.45, 0.74],
   [0.51, 0.39], [0.51, 0.56], [0.51, 0.74]],
  // Frame 1 — slight exhale (shoulders/arms drop a hair)
  [[0.52, 0.10], [0.49, 0.18], [0.44, 0.21], [0.40, 0.31], [0.40, 0.42],
   [0.54, 0.21], [0.56, 0.31], [0.56, 0.42],
   [0.45, 0.40], [0.45, 0.56], [0.45, 0.74],
   [0.51, 0.40], [0.51, 0.56], [0.51, 0.74]],
  // Frame 2 — same as 0
  [[0.52, 0.10], [0.49, 0.18], [0.44, 0.20], [0.40, 0.30], [0.40, 0.40],
   [0.54, 0.20], [0.56, 0.30], [0.56, 0.40],
   [0.45, 0.39], [0.45, 0.56], [0.45, 0.74],
  ...
  [[0.52, 0.09], [0.49, 0.17], [0.44, 0.19], [0.40, 0.29], [0.40, 0.39],
   [0.54, 0.19], [0.56, 0.29], [0.56, 0.39],
   [0.45, 0.39], [0.45, 0.56], [0.45, 0.74],
   [0.51, 0.39], [0.51, 0.56], [0.51, 0.74]],
];
